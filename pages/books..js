...
export default function Books() {
  return (
    <Layout>
      ...
      <Head>
        <title>Books - Anthony Avedissian</title>
      </Head>
        <div className='flex flex-col gap-4'>
          ...
          <li><a className='text-blue-600' target="_blank" href="https://www.goodreads.com/book/show/82256.The_Sovereign_Individual">Sovereign Individual</a> by Davidson and Rees-Mogg</li>
