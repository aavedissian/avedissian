    ...
    <Layout>
      ...
      <Head>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p>Please message me on <a className='text-blue-600' target="_blank" href="https://twitter.com/antavedissian">Twitter</a> or <a className='text-blue-600' href="mailto:anthony@seedclub.ventures">email</a> to discuss further.</p>
        </div>
    </Layout>
  )
}