    ...
    <Layout>
      ...
      <Head>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p>My name is Anthony Avedissian. I invest in technology startups at <a className='text-blue-600' target='_blank' href="https://seedclub.ventures/">Seed Club Ventures</a> and co-design fine jewelry with my wife at <a className='text-blue-600' target='_blank' href="https://www.laravalentina.com">Lara Valentina</a>.</p>
