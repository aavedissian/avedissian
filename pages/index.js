    ...
    <Layout>
      ...
      <Head>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p>I live in Los Angeles with my wife and enjoy designing <a className='text-blue-600' target='_blank' href="https://www.laravalentina.com">jewelry</a>, reading, <a className='text-blue-600' target='_blank' href="https://www.instagram.com/antilosh.eats/">cooking</a>, running, swimming, skiing, hiking, and Muay Thai.</p>
