    ...
    <Layout>
      ...
      <Head>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p>My name is Anthony Avedissian. I am invest an investor at <a className='text-blue-600' target='_blank' href="https://seedclub.ventures/">Seed Club Ventures</a>.</p>
          ...
          <p>I grew up in London, regularly traveling to Istanbul and Yerevan, and have lived in 10+ cities, including Miami, Lisbon, Shanghai, Phuket, and Barcelona.</p>
