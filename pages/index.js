  ...
  return (
    <Layout>
        <div className='flex flex-col gap-4'>
          ...
          <p>I enjoy reading, <a target='_blank' href="https://www.instagram.com/antilosh.eats/">cooking</a>, running, swimming, skiing, hiking, and training Muay Thai.</p>
          <p>You can reach me on <a target='_blank' href="https://twitter.com/antavedissian">Twitter</a> and find my writing on <a target='_blank' href="https://anthonyavedissian.substack.com/">Substack</a>.</p>
        </div>
    </Layout>
  )
}
