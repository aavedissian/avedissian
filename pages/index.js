  ...
  return (
    <Layout>
        <div className='flex flex-col gap-4'>
          ...
          <p>My name is Anthony Avedissian. I live in Los Angeles with my wife and invest in technology startups at <a className='text-blue-600' target='_blank' href="https://seedclub.ventures/">Seed Club Ventures</a>.</p>
          ...
          <p>I enjoy reading, <a className='text-blue-600' target='_blank' href="https://www.instagram.com/antilosh.eats/">cooking</a>, running, swimming, skiing, hiking, and Muay Thai.</p>
