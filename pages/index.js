    ...
    <Layout>
      ...
      <Head>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p>My name is Anthony Avedissian. I invest in and advise early-stage startups. Together with my wife, Lara, I also design and craft <a className='text-blue-600' target='_blank' href="https://www.laravalentina.com/">fine jewelry</a>.</p>
     
          <p>I live in Los Angeles and enjoy reading, <a className='text-blue-600' target='_blank' href="https://www.instagram.com/antilosh.eats/">cooking</a>, swimming, skiing, hiking, golf, tennis, and Muay Thai.</p> 
