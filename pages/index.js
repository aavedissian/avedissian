    ...
    <Layout>
      ...
      <Head>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p>My name is Anthony Avedissian. I invest in early-stage startups at <a className='text-blue-600' target='_blank' href="https://www.seedclub.xyz/">Seed Club</a>.</p>
     
          <p>I live in Los Angeles with my wife and enjoy reading, <a className='text-blue-600' target='_blank' href="https://www.instagram.com/antilosh.eats/">cooking</a>, swimming, skiing, hiking, tennis, and Muay Thai.</p> 
