    ...
    <Layout>
      ...
      <Head>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p>My name is Anthony Avedissian. I invest in early-stage startups at <a className='text-blue-600' target='_blank' href="https://seedclub.ventures/">Seed Club Ventures</a>. Together with my wife, Lara, I also design and craft <a className='text-blue-600' target='_blank' href="https://www.laravalentina.com/">fine jewelry</a>.</p>
