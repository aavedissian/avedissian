  ...
  return (
    <Layout>
        <div className='flex flex-col gap-4'>
          ...
          <li><span className="font-bold">Compound.</span> The greatest returns in life come from <a className='text-blue-600' href="https://anthonyavedissian.substack.com/p/on-compounding">compounding</a>. Keep consistent and play long-term games, especially for relationships.</li>
