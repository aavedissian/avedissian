  ...
  return (
    <Layout>
        <div className='flex flex-col gap-4'>
          ...
          <li>Compound. The greatest returns in life, whether in wealth, relationships, or knowledge, come from <a className='text-blue-600' href="https://anthonyavedissian.substack.com/p/on-compounding">compound interest</a>.</li>
          ...
          <li>Engineer serendipity. Luck is not magic. It is a state of mind and a property of networks. It can be measured, analyzed, and <a className='text-blue-600' href="https://medium.com/aspen-ideas/engineering-serendipity-941e601a9b65">engineered</a>.</li>
          ...
          <li>Live holistically. Work-life balance is a <a className='text-blue-600' target="_blank" href="https://blog.nateliason.com/p/work-life-balance">false dichotomy</a>, implying work and life must be traded off. Instead, integrate work as one part of a holistic life, where each area supports and complements others.</li>
          ...
          <li>Look forward. Make decisions based on <a className='text-blue-600' target="_blank" href="https://en.wikipedia.org/wiki/Sunk_cost">future value</a>, not unrecoverable past events/investments.</li>
          ...
          <li>Maintain efficiency. 80% of results are often driven by <a className='text-blue-600' target="_blank" href="https://en.wikipedia.org/wiki/Pareto_principle">20% of efforts</a>.</li>
