  ...
  return (
    <Layout>
        <div className='flex flex-col gap-4'>
          ...
          <p>I invest in Pre-Seed and Seed rounds. I love meeting founders, playing with <a className='text-blue-600' target="_blank" href="https://cdixon.org/2010/01/03/the-next-big-thing-will-start-out-looking-like-a-toy">toys</a>, and navigating the <a className='text-blue-600' target="_blank" href="https://cdixon.org/2013/08/04/the-idea-maze">idea maze</a>.</p>
